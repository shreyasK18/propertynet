...
import {FaBed,FaBath,FaRulerCombined,FaMoneyBill,FaMapMarker}
from 'react-icons/fa';
const PropertyCard = ({property}) => {
    ...
    return ( <div className="rounded-xl shadow-md relative">
        ...
        <div className="p-4">
          ...
          >
           {property.rates.weekly && <p><FaMoneyBill/>$ {property.rates.weekly.toLocaleString()} / Weekly</p>}
           {property.rates.monthly && <p><FaMoneyBill/>$ {property.rates.monthly.toLocaleString()} / Monthly</p>}
           {property.rates.nightly && <p><FaMoneyBill/>$ {property.rates.nightly.toLocaleString()} / Nightly</p>}
          </div>
